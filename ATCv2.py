...
<html>
<head>
    <title>DONOVIAN AIR DEFENSE SYSTEM - TACTICAL AIR CONTROL</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="header">
            ...
            <h1>US ARMY ATC</h1>
            <div class="subtitle">DONOVIAN AIR DEFENSE SYSTEM</div>
        </div>
...
def get_user_input():
    ...
    print("="*70)
    print(" DONOVINA AIR DEFENSE SYSTEM")
    ...
    while True:
        try:
            lat = float(input("Enter center latitude(AUGSTA,GA 33.9420: ").strip())
            if -90 <= lat <= 90: break
    ...
    while True:
        try:
            lon = float(input("Enter center longitude(AUGUSTA,GA -82.1442: ").strip())
...
def main():
    ...
    try:
        ...
        print("\nStarting Donovian Air Defense system on port 8888...")
        ...
        print("\n" + "="*70)
        print(" DONOVIAN AIR DEFENSE SYSTEM - READY")
        print("="*70)
        print()
